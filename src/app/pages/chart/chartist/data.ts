...
const barChart: ChartType = {
    ...
    series: [{
        data: [58509,30594,9049,3011.5,1330,867,374,314,]
    }],
    colors: ['#34c38f'],
    xaxis: {
        // tslint:disable-next-line: max-line-length
        categories: ['Congé annuel', 'Congé maladie','Congé maternité','Absence irréguliére','Décés d abcendants','Congé longue maladie','Congé spéciale','Réquisition','Nouveau né','Congé récuperation','Circoncision'],
    },
    grid: {
        borderColor: '#f1f1f1'
    },
...
const pieChart: ChartType = {
    series: [{
        data: [
            { value: 46902, name: 'Masulin 46902' },
             { value:58537, name: 'Féminin 58537' }],
        type: 'pie',
    }],
    color: ['#556ee6', '#f46a6a'],
    legend: {
        x: 'center',
        y: 'bottom',
        data: ['Féminin 58537','Masulin 46902'],
    },
    tooltip: {
        trigger: 'axis'
    },
...
export {
    ...
    lineColumAreaChart, simplePieChart, donutChart, basicRadialBarChart, dashedLineChart,pieChart
};
